...
authenticate private repositories, as preparation for the project installation
step. Note that because this script is meant to be run prior
...
should not be hardcoded in this file, but (for example) provided as environment variables.
"""
